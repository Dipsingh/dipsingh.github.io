...
$
var(\hat\beta_{j}) = (se_{j})^2  = \frac{1}{(1-R_{j}^2)}(\frac{s^2}{(n-1)s^2_{xj}})
$

where $s^2_{xj}$ denotes the sample variance of ${x_{j}}$. The variance inflation factor $VIF_{j}=\frac{1}{(1-R^2_{j})}$ 
