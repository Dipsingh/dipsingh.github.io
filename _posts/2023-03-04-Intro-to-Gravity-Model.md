...
=\alpha[D_{v}(\sum_{k \in V}D_{k}+D'_{v}-D_{v})+\sum_{j\in V\smallsetminus{i,v}}D_{j}(D'_{v}- D_{v})+(\sum_{j\in V\smallsetminus{i,v}}D_{j}\sum_{k \in V}D_{k}) -(\sum_{k\in V}D_{k}D'_{v}-\newline (\sum_{j\in V\smallsetminus{i,v}}D_{j}\sum_{k \in V}D_{k})] 

=\alpha[D_{v}(\sum_{k \in V}D_{k}+D'_{v}-D_{v})+\sum_{j\in V\smallsetminus{i,v}}D_{j}(D'_{v}- D_{v})-(\sum_{k\in V}D_{k}D'_{v})] 


=\alpha[D_{v}(\sum_{k \in V}D_{k}+D'_{v}-D_{v})+(\sum_{j\in V\smallsetminus{i,v}}D_{j}D'_{v}) - (\sum_{k\in V}D_{k}D'_{v})- (\sum_{j\in V\smallsetminus{i,v}}D_{j}D_{v})] \newline
...
=\alpha[(D_{v}(\sum_{k \in V}D_{k}- \sum_{j\in V\smallsetminus{i,v}}D_{j})+(D_{v}D'_{v})-(D_{v}D_{v})-D'_{v}(D_{i}+D_{v})] \newline

\sum_{k \in V}D_{k}- \sum_{j\in V\smallsetminus{i,v}}D_{j} = D_{i}+D_{v} \newline
