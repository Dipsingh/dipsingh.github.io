...
Below is a comparison of the Transistor structure from Dennard's 1974 paper with Intel's 65nm generation in 2005. You can the gate length decreased from $\approx1\micro\text{m}$ to $35nm$ and gate oxide thickness from $35nm$ to $1.2nm$. 
