...
and explore how they can be applied to optimization problems.

{: .center}
![XKCD](/images/post28/fig1.png "xkcd")
...
<iframe src="{{ '_includes/interative_plot.html' }}" width="100%" height="500px" frameborder="0"></iframe>
...
<iframe src="{{ '_includes/interative_3d_plot.html' }}" width="100%" height="500px" frameborder="0"></iframe>
...
So we have already some introduction of Lagrangian in this https://dipsingh.github.io/Balancing-MMLU-PathCostConstraints/ without 
